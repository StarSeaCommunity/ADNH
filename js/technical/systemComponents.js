    ...
    'options-tab': {
        ...
        <table><br><br><br><br><br><br>
			...
			<tr>
				...
				<td><button class="opt" onclick="toggleCdOpt()">{{i18n('冷却时间', 'Cooldowns', false)}}: {{ (player.settings && player.settings.coolDownsEnabled !== false) ? (i18n("已开启", "ON", false)):(i18n("已关闭", "OFF", false))}}</button></td>
            </tr><br>
            <tr>
